    ...
    <div className="mt-8 mb-16">
      ...
      <div className="flex flex-col gap-y-2 px-0 sm:px-16">
        <p>
          ...
          a zip file with many ROM files inside it.
        </p>
        <p>
          I&apos;ve also noticed Neo Geo ROM hacks are hard to find.
          They&apos;re spread out all over forums, file upload sites, YouTube,
          etc.
        </p>
        <p>
